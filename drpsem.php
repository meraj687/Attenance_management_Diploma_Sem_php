...
<body>
 ...
 <option value="index.php">Semester 1 </option> 
 <option value="index1.php">Semester 2 </option> 
 <option value="index2.php">Semester 3 </option> 
 <option value="index3.php">Semester 4 </option> 
 <option value="index4.php">Semester 5 </option> 
 <option value="index5.php">Semester 6 </option> 
</select> 
  </center>
